                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result == "err401") {
                            ...
                            window.location.href = "DangNhap.aspx?p=PO_Ao_DonVi.aspx";
                        }
                        else {
    ...
    DS_VatTu = new kendo.data.DataSource({
        transport: {
            read: function (options) {
                $.ajax({
                    type: "POST",
                    url: "assets/ajax/Ajax_PO_Ao_DonVi.aspx",
                    data: {
            ...
            [
                {
                    ...
                    template: function (data) {
                        ...
                        if (data.TinhTrangChuyen == '0') {
                            return '<center><span class="label label-success">Chưa chuyển</span></center>';
                        }
                        else {
                            return '<center><span class="label label-important">Đã chuyển</span></center>';
                        }
                    },
                    width: "8%"
                },
