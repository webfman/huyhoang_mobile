                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result == "err401") {
                            ...
                            window.location.href = "DangNhap.aspx?p=PO_Cha.aspx";
                        }
                        else {
    ...
    if (confirm("Bạn có chắc chắn muốn gỡ xuất PO con này không?")) {
        ...
        request.done(function (msg) {
            ...
            switch (msg[0].ErrorMessage) {
                case "Co_Thanh_Toan":
                    alert("PO con này đã thanh toán nêu không thể gỡ xuất!");
                    break;
                case "Co_TienDo_ThucTe":
                    alert("PO con này nhà thầu đã cam kết thực tế nêu không thể gỡ xuất!");
                    break;
                case "Co_TienDo_CamKet":
                    alert("PO con này nhà thầu đã cam kết nêu không thể gỡ xuất!");
                    break;
                case null:
                    //alert("Đã gỡ xuất thành công!");
                    $("#notification").data("kendoNotification").show({
    ...
    if (check == 0) {
        ...
        request.done(function (msg) {
            ...
            if (msg[0].ErrorMessage == null) {
                ...
                $("#notification").data("kendoNotification").show({
                    message: "Đã sửa thành công vật tư!"
                }, "upload-success");
