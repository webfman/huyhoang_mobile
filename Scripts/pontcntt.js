            ...
            var ds = new kendo.data.DataSource({
                ...
                requestEnd: function (event) {
                    if (event.response.d.Total > 0)
                        ...
                        setNotificationPosition(notification, getBottom($('#txtSoVB')) + 7, null, null, getLeft($('#txtSoVB')));
                        notification.warning('Không tìm thấy số văn bản này do một trong những nguyên nhân sau:<ul><li>Số văn bản không tồn tại</li><li>Chưa khóa cập nhật số lượng cam kết</li><li>Đã khóa cập nhật số lượng thực tế</li><li>Thuộc quyền quản lý của nhà thầu khác</li></ul>');
                ...
                transport: {
                    ...
                    read: {
                        ...
                        dataType: 'json',
                        type: 'POST',
                        url: 'PONT_CapNhatThucTe.aspx/GetDSPONhaThau'
                    }
                }
            });
            ds.read();
                ...
                $("<div/>").appendTo(e.detailCell).kendoGrid({
                    ...
                    dataSource: {
                        ...
                        transport: {
                            ...
                            read: {
                                ...
                                dataType: 'json',
                                type: 'POST',
                                url: 'PONT_CapNhatThucTe.aspx/GetDSDonVi'
                            }
                        }
                    },
                    detailExpand: function (e) {
                    ...
                    detailInit: function (e) {
                        $("<div/>").appendTo(e.detailCell).kendoGrid({
                            ...
                            columns: [
                                { field: 'Id', hidden: true },
                                { field: 'TenVatTu', headerAttributes: { 'style': 'vertical-align:middle' }, title: 'Tên Vật Tư', width: 150 },
                                ...
                                { field: 'ThoiGianCapNhatThucTe', title: 'Thời Gian<br/>Cập Nhật Thực Tế', width: 130 },
                                {
                                    command: {
                                        name: 'xemLichSu',
                                        text: "&nbsp;&nbsp;Xem lịch sử",
                                        click: function (e) {
                                            ...
                                            if (data.ThoiGianCapNhatThucTe !== '') {
                                                $.ajax({
                                                    contentType: 'application/json; charset=utf-8',
                                                    data: JSON.stringify({ PONhaThauChiTietId: data.Id }),
                                                    dataType: 'json',
                                                    type: 'POST',
                                                    url: 'PONT_CapNhatThucTe.aspx/GetLichSu'
                                                })
                                                .done(function (response) {
                                                    $('#gvLichSu').kendoGrid({
                                                        columns: [
                                                            { field: 'SoLuong', title: 'Số Lượng' },
                                                            { field: 'Ngay', title: 'Ngày Thực Tế' },
                                                    ...
                                                    dlgLichSu.title('Lịch Sử Xác Nhận Thực Tế Của Vật Tư: ' + data.TenVatTu);
                                                ...
                                                notification.warning('Chưa có lịch sử xác nhận thực tế');
                                            }
                                        },
                            ...
                            dataSource: {
                                change: function (e) {
                                    if (e.action === 'itemchange' && e.items[0].NgayThucTe !== null && e.items[0].SoLuongThucTe > 0 && e.items[0].SoLuongThucTe <= e.items[0].SoLuongGiaoHang)
                                        this.sync();
                                },
                                error: function () {
                                    alert('Lỗi đường truyền');
                                ...
                                requestEnd: function (e) {
                                    if (e.response && e.type === 'update') {
                                        if (e.response.d.ThoiGianCapNhatThucTe === '00:00:00 01/01/2000') {
                                            setNotificationPosition(notification, $(window).height() / 2, null, null, $(window).width() / 2);
                                            notification.warning('Đơn hàng này đã bị khóa cập nhật số lượng thực tế');
                                            this.cancelChanges();
                                        }
                                        else
                                            this.read();
                                ...
                                schema: {
                                    ...
                                    model: {
                                        ...
                                        fields: {
                                            ...
                                            NgayCamKet: { editable: false, type: 'date' },
                                            ...
                                            SoLuongThucTe: {
                                                ...
                                                validation: {
                                                    checkSL: function (input) {
                                                        if (input.attr('name') === 'SoLuongThucTe' && parseInt(input.val()) > parseInt(input.closest('td').siblings().eq(3).text().replace(/\./g, ''))) {
                                                            input.attr("data-checkSL-msg", "Số lượng thực tế không được lớn hơn số lượng đặt hàng");
                                                            return false;
                                                        }
                                                        return true;
                                                    }
                                            ...
                                            NgayThucTe: { nullable: false, editable: true, type: 'date' },
                                            ThoiGianCapNhatThucTe: { editable: false }
                                        }
                                    },
                                    total: 'd.Total'
                                },
                                ...
                                transport: {
                                    parameterMap: function (data, operation) {
                                        if (operation === 'read')
                                            ...
                                            data.NgayThucTe = kendo.toString(data.NgayThucTe, 'dd/MM/yyyy');
                                    ...
                                    read: {
                                        ...
                                        dataType: 'json',
                                        type: 'POST',
                                        url: 'PONT_CapNhatThucTe.aspx/GetDSVatTuTT'
                                    },
                                    update: {
                                        contentType: "application/json; charset=utf-8",
                                        dataType: 'json',
                                        type: 'POST',
                                        url: 'PONT_CapNhatThucTe.aspx/CapNhatSoLuongTT'
                                    }
                                }
                            },
                            editable: true,
