        ...
        init: function (element, options) {
            ...
            if (options.excel) {
                ...
                options.toolbar = $.merge([
                    {
                        name: "export",
                        template: kendo.format("<a class='k-button k-button-icontext k-grid-export' title='Export to Excel'><div  class='{0} k-icon'></div>Xuất Excel</a>", options.excel.cssClass)                        
                    }
                ], options.toolbar || []);
            }
